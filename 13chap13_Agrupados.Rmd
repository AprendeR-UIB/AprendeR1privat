...
```{example,alerg}
Mucha gente manifiesta reacciones alérgicas sistémicas a las picaduras de insecto. 
...
```{example}
Seguimos con el Ejemplo \@ref(exm:alerg); vamos a continuar el proceso de agrupamiento de los datos en $k=7$ clases.
